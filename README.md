...
<p align="justify">The E-Baon for CSF System is a web and mobile platform for parcel pick-up and drop-off in the City of San Fernando, La Union. It enables customers to schedule deliveries and allows drivers to manage requests, offering fast, secure, and reliable local delivery with real-time tracking and digital transactions.</p>
