...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <link rel="stylesheet" href="../../Css/Customer/Profile_Homepage.css">
            <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css">
            <script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"></script>
            <script src="../../Javascript/Customer/Profile_Homepage.js" defer></script>
        </head>
        <body class="profile-body">
            ...
            <div class="profile-shell">
                ...
                <aside class="customer-sidebar">
                    ...
                    <button type="button" class="customer-sidebar-item" data-action="home">
                        <span class="customer-sidebar-icon">🏠</span>
                        <span class="customer-sidebar-label">Home</span>
                    </button>

                    <button type="button" class="customer-sidebar-item" data-action="menu">
                ...
                <main class="profile-main">
                    ...
                    <div class="profile-header-row">
                        <h1 class="profile-page-title">Settings</h1>
                    </div>
                                    ...
                                    <div class="profile-photo-block">
                                        <div class="profile-photo-preview" id="profile-photo-preview">
                                            <span class="profile-photo-initial" id="profile-photo-initial">
                                                <?php echo strtoupper(substr($user["full_name"] !== "" ? $user["full_name"] : "C", 0, 1)); ?>
                                            </span>
                                        </div>
